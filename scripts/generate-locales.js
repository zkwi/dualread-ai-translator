...
const en = {
  ...
  popupSkippedTargetLanguageHint: "Click Start translation if you still want to force translation.",
  popupSkippedTargetLanguageStatus: "Auto translation skipped: this page is already in the target language.",
  ...
  thinkingHintDashscope: "Adds enable_thinking: false to DashScope requests.",
  thinkingHintSelfHosted: "Adds chat_template_kwargs.enable_thinking = false for local Qwen-compatible services.",
  thinkingHintNone: "This provider does not need extra thinking parameters.",
  thinkingHintDisabled: "Disabled: requests will not include thinking-control parameters.",
...
const ja = {
  ...
  popupSkippedTargetLanguageHint: "それでも翻訳したい場合は「翻訳開始」をクリックしてください。",
  popupSkippedTargetLanguageStatus: "自動翻訳をスキップしました：このページはすでに目標言語です。",
  ...
  thinkingHintDashscope: "DashScope リクエストに enable_thinking: false を追加します。",
  thinkingHintSelfHosted: "ローカル Qwen 互換サービス向けに chat_template_kwargs.enable_thinking = false を追加します。",
  thinkingHintNone: "このサービスでは追加の思考パラメータは不要です。",
  thinkingHintDisabled: "無効：思考制御パラメータはリクエストに追加されません。"
};
